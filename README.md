...
GITHUB_REPO=""  # UPDATE with YOUR repo
...
**Full workflow file reference:** [`.github/workflows/build-push-ui.yaml`](https://github.com/QuasarRay/E-commerce/blob/main/.github/workflows/build-push-ui.yaml)
...
**Live example:** [GitHub Actions for this Repo](https://github.com/QuasarRay/E-commerce)
...
1. Navigate to [`src/ui/chart/values-ui.yaml`](https://github.com/QuasarRay/E-commerce/blob/main/src/ui/chart/values-ui.yaml)
...
- **Workflow File:** [`.github/workflows/build-push-ui.yaml`](https://github.com/QuasarRay/E-commerce/blob/main/.github/workflows/build-push-ui.yaml)
